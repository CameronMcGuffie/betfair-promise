...
class BetfairAuth {
    ...
    constructor(authUrls=AUTH_URLS) {
    ...
    loginInteractive(login, password, cb = ()=> {}) {
        ...
        HttpRequest.post(this.authUrls.interactiveLogin, formData, options, (err, res) => {
            if (err) {
                cb(err);
                return;
            }
    ...
    logout(sessionKey, cb = ()=> {}) {
        ...
        HttpRequest.post(this.authUrls.logout, formData, options, (err, res) => {
            if(err) {
                cb(err);
                return;
            }
    ...
    keepAlive(sessionKey, cb = ()=> {}) {
        ...
        HttpRequest.post(this.authUrls.keepAlive, formData, options, (err, res) => {
            if(err) {
                cb(err);
                return;
            }
